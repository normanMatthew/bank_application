    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Sint proident reprehenderit minim nulla Lorem id laboris commodo velit aliquip commodo quis. Esse enim quis culpa mollit veniam fugiat aute reprehenderit incididunt cupidatat culpa. In commodo consectetur sint est nostrud eu. Ipsum eiusmod aute tempor labore sit ipsum sunt eiusmod esse cupidatat consequat sunt.</p>
      </div>
